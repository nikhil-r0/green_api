...
# Load the ONNX model
model_path = "models/chat_bot/chatbot_model.onnx"  # Update this path to your model's location
...
json_file_path = "models/chat_bot/chatbot.json"  # Update this path to your JSON file
